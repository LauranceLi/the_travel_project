...
//有資料就繼續，跟本不存在的資料
$r = $pdo->query("SELECT * FROM interest_list WHERE sid=$sid")->fetch();
if (empty($r)) {
    header('Location: interest_list.php');
    exit;
}
                ...
                <div class="card-body">
                    ...
                    <form name="form1" onsubmit="sendData(event)">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="contect" name="contect" value="<?= $r['contect'] ?>">
                            <div class="form-text"></div>
                        </div>
                        <div class="mb-3">
