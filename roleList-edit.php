...
//   };
  ...
  // print_r($_POST[$role_id.'roleSet'] ?? null);
  // print_r($_POST[$role_id.'employee'] ?? null);
  // print_r($_POST[$role_id.'member'] ?? null);
  // print_r($_POST[$role_id.'point'] ?? null);
  print_r($_POST[$role_id.'itinerary'] ?? null);
  // print_r($_POST[$role_id.'order'] ?? null);
  // print_r($_POST[$role_id.'product'] ?? null);
  // print_r($_POST[$role_id.'form'] ?? null);



  // echo $roleSetAuthor;
  // echo $employeesAuthorized.',';
  // echo $membersAuthorized.',';
  // echo $pointsAuthorized.',';
  echo $itineraryAuthorized;
  // echo $ordersAuthorized.',';
  // echo $productsAuthorized.',';
  // echo $formAuthorized.',';
  // $editAuthority_sql = "UPDATE `permission` SET `role_set`='$roleSetAuthorized',`employees`='$employeesAuthorized', `members`='$membersAuthorized',
...
// $update_role_desc_sql = "UPDATE `role_set` SET `description`='$edit_role_desc' WHERE 1"; 
